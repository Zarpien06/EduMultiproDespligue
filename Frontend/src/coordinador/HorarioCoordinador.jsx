...
import './css/HorarioCoordinador.css';
                    ...
                    <div className="row" id='contenido'>
                        ...
                        <div className="col-10" id="contenidoTabla">
                            <div className="titulo2">
                                ...
                                <Link to={"/CrearHorarioCoordinador"}>
                            ...
                            <table className="tablaUsuarios" id="tablaUsuarios">
                                ...
                                <tbody>
                                        ...
                                        <tr key={horario.ID}>
                                            ...
                                            <td>
                                            <Link to={`/VerHorarioCoordinador/${horario.ID}`}>
                                            ...
                                            <td>
                                            <Link to={`/ActualizarHorarioCoordinador/${horario.ID}`}>
...
export default HorarioCoordinador;