...
import './css/CrearAulaProfesor.css';
    ...
    <>
        ...
        <div className='contenedor'>
            ...
            <div className="container-fluid" id="centroProfesor">
                ...
                <div className="tituloCrearAulaProfesor">
                    <h1>Crear Aula</h1>
                    <Link to={"/ClaseProfesor"}>
                        <button className="crear" id="btnAgregarUsuario">Salir</button>
                    </Link>
                </div>

                <div className="contenidoCrearAulaProfesor">
...
export default CrearAulaProfesor;